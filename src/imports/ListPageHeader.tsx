import svgPaths from "./svg-pq6ddp16ij";
...
function Background({ additionalClassNames = "" }: BackgroundProps) {
  return (
    <div className={clsx("absolute inset-0 rounded-[4px] z-[1]", additionalClassNames)}>
...
export default function ListPageHeader() {
  return (
    <div className="bg-[#f5f5f5] content-stretch flex flex-col gap-[16px] items-start pb-0 pt-[24px] px-[24px] relative size-full" data-name="List Page Header">
      <div className="h-[48px] relative shrink-0 w-full" data-name="Title + Global CTAs">
        <div className="absolute content-stretch flex gap-[8px] items-center right-0 top-0" data-name="Buttons">
          <div className="content-stretch flex flex-col isolate items-start overflow-clip relative shrink-0" data-name="Quick Links">
          ...
          <div className="content-stretch flex flex-col isolate items-start overflow-clip relative shrink-0" data-name="Button 3">
            <div className="content-stretch flex flex-col h-[48px] isolate items-start overflow-clip relative shrink-0 z-[1]" data-name="Layout">
              ...
              <Background additionalClassNames="bg-white" />
            </div>
          </div>
          <div className="content-stretch flex flex-col isolate items-start overflow-clip relative shrink-0" data-name="Button 2">
            <div className="content-stretch flex flex-col h-[48px] isolate items-start overflow-clip relative shrink-0 z-[1]" data-name="Layout">
              <Content>
                <div className="flex flex-col font-['Lato:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#66256a] text-[14px] text-nowrap z-[2]">
                  <p className="leading-[20px]">Secondary</p>
                </div>
              </Content>
              <Background additionalClassNames="bg-white" />
            </div>
          </div>
          <div className="content-stretch flex flex-col isolate items-start relative shrink-0" data-name="Button 1">
            <div className="content-stretch flex flex-col isolate items-start overflow-clip relative shrink-0 z-[1]" data-name="Layout">
              <Content>
              ...
              <Background additionalClassNames="bg-[#66256a]" />
            </div>
          </div>
        </div>
        <div className="absolute content-stretch flex items-start left-0 top-[4px]" data-name="Object">
          <div className="content-stretch flex items-start relative shrink-0" data-name="📦 Heading">
            <div className="flex flex-col font-['Lato:Black',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#211e22] text-[27.34px] text-nowrap">
              <p className="leading-[40px]">Object</p>
            </div>
          </div>
        </div>
      </div>
      <div className="h-[48px] relative shrink-0 w-full" data-name="Tabs + Help">
        ...
        <div className="absolute content-stretch flex flex-col isolate items-start overflow-clip right-0 top-0" data-name="Help Button">
          <div className="content-stretch flex flex-col isolate items-start overflow-clip relative shrink-0 z-[1]" data-name="Layout">
            <div className="content-stretch flex gap-[4px] isolate items-center justify-center relative shrink-0 w-full z-[1]" data-name="Content">
